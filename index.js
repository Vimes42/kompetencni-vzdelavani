...
/*
            ...
            <div intro class="characteristics__char3"><img src="/img/check_157977.png" alt="icon_check" class="icon_check">Průběžné a formativní hodnocení: Hodnocení je průběžné a formativní.
                Studenti dostávají zpětnou vazbu v průběhu celého procesu učení a mohou
                se tak neustále zlepšovat.</div>
            <div intro class="characteristics__char4"><img src="/img/check_157977.png" alt="icon_check" class="icon_check">Modulární a flexibilní obsah: Obsah je modulární a flexibilní. Studenti si
                mohou vybrat moduly, které je zajímají a které jim pomohou dosáhnout jejich cílů.</div>
            <div intro class="characteristics__char5"><img src="/img/check_157977.png" alt="icon_check" class="icon_check">Individuální tempo: Studenti se učí svým vlastním tempem. Neexistuje
                žádné jednotné tempo pro všechny.</div>
            <div intro class="characteristics__char6"><img src="/img/check_157977.png" alt="icon_check" class="icon_check">Učitel jako facilitátor: Učitel je facilitátor a průvodce. Pomáhá studentům učit
                se a rozvíjet své kompetence.</div>
